...
#define states states_ProbAMPANMDA_EMS 
...
#define unoccupied _p[20*_STRIDE]
#define occupied _p[21*_STRIDE]
#define tsyn _p[22*_STRIDE]
#define u _p[23*_STRIDE]
...
#define mggate _p[30*_STRIDE]
#define DA_AMPA _p[31*_STRIDE]
#define DB_AMPA _p[32*_STRIDE]
#define DA_NMDA _p[33*_STRIDE]
#define DB_NMDA _p[34*_STRIDE]
#define _v_unused _p[35*_STRIDE]
#define _g_unused _p[36*_STRIDE]
#define _tsav _p[37*_STRIDE]
...
LIKWID_MARKER_START("ProbAMPANMDA_EMS_net_recv");
#endif
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbAMPANMDA_EMS_net_recv");
#endif
  #pragma acc wait(stream_id)
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__ProbAMPANMDA_EMS  %d\n", _nt->_id);*/
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_START("ProbAMPANMDA_EMS_current");
#endif
for (_iml = 0; _iml < _cntml_actual; ++_iml) {
#else /* LAYOUT > 1 */ /*AoSoA*/
#error AoSoA not implemented.
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbAMPANMDA_EMS_current");
#endif
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_START("ProbAMPANMDA_EMS_reduction_cur");
#endif
#ifdef _OPENACC
    if(!(_nt->compute_gpu)) { 
        for (_iml = 0; _iml < _cntml_actual; ++_iml) {
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbAMPANMDA_EMS_reduction_cur");
#endif
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_START("ProbAMPANMDA_EMS_state");
#endif
for (_iml = 0; _iml < _cntml_actual; ++_iml) {
#else /* LAYOUT > 1 */ /*AoSoA*/
#error AoSoA not implemented.
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbAMPANMDA_EMS_state");
#endif
