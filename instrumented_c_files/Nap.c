...
#define ena _p[4*_STRIDE]
#define mInf _p[5*_STRIDE]
#define hInf _p[6*_STRIDE]
#define hTau _p[7*_STRIDE]
#define hAlpha _p[8*_STRIDE]
#define hBeta _p[9*_STRIDE]
...
LIKWID_MARKER_START("Nap_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("Nap_current");
#endif
