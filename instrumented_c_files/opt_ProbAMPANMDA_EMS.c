...
#define nrn_init _nrn_init__ProbAMPANMDA_EMS_Opt
#define nrn_cur _nrn_cur__ProbAMPANMDA_EMS_Opt
#define _nrn_current _nrn_current__ProbAMPANMDA_EMS_Opt
#define nrn_jacob _nrn_jacob__ProbAMPANMDA_EMS_Opt
#define nrn_state _nrn_state__ProbAMPANMDA_EMS_Opt
#define initmodel initmodel__ProbAMPANMDA_EMS_Opt
#define _net_receive _net_receive__ProbAMPANMDA_EMS_Opt
#define nrn_state_launcher nrn_state_ProbAMPANMDA_EMS_Opt_launcher
#define nrn_cur_launcher nrn_cur_ProbAMPANMDA_EMS_Opt_launcher
#define nrn_jacob_launcher nrn_jacob_ProbAMPANMDA_EMS_Opt_launcher 
#if NET_RECEIVE_BUFFERING
#define _net_buf_receive _net_buf_receive_ProbAMPANMDA_EMS_Opt
static void _net_buf_receive(_NrnThread*);
#endif
 
#define setRNG setRNG_ProbAMPANMDA_EMS_Opt 
#define state state_ProbAMPANMDA_EMS_Opt 
...
#define NMDA_ratio _p[13*_STRIDE]
#define A_AMPA_step _p[14*_STRIDE]
#define B_AMPA_step _p[15*_STRIDE]
#define A_NMDA_step _p[16*_STRIDE]
#define B_NMDA_step _p[17*_STRIDE]
#define unoccupied _p[18*_STRIDE]
#define occupied _p[19*_STRIDE]
#define tsyn _p[20*_STRIDE]
#define u _p[21*_STRIDE]
#define A_AMPA _p[22*_STRIDE]
#define B_AMPA _p[23*_STRIDE]
#define A_NMDA _p[24*_STRIDE]
#define B_NMDA _p[25*_STRIDE]
#define i_AMPA _p[26*_STRIDE]
#define i_NMDA _p[27*_STRIDE]
#define g_NMDA _p[28*_STRIDE]
#define factor_AMPA _p[29*_STRIDE]
#define factor_NMDA _p[30*_STRIDE]
#define mggate _p[31*_STRIDE]
#define DA_AMPA _p[32*_STRIDE]
#define DB_AMPA _p[33*_STRIDE]
#define DA_NMDA _p[34*_STRIDE]
#define DB_NMDA _p[35*_STRIDE]
#define _v_unused _p[36*_STRIDE]
#define _g_unused _p[37*_STRIDE]
...
#endif /*BBCORE*/
#define toggleVerbose toggleVerbose_ProbAMPANMDA_EMS_Opt
#define urand urand_ProbAMPANMDA_EMS_Opt
 inline double toggleVerbose( _threadargsproto_ );
 inline double urand( _threadargsproto_ );
 /* declare global and static user variables */
#define gmax gmax_ProbAMPANMDA_EMS_Opt
 double gmax = 0.001;
...
static void _acc_globals_update() {
 ...
 "gmax_ProbAMPANMDA_EMS_Opt", &gmax_ProbAMPANMDA_EMS_Opt,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _opt_ProbAMPANMDA_EMS_reg() {
	int _vectorized = 1;
  _initlists();
...
static void _net_buf_receive(_NrnThread* _nt) {
  ...
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__ProbAMPANMDA_EMS_Opt  %d\n", _nt->_id);*/
...
static int _ode_count(int _type){ hoc_execerror("ProbAMPANMDA_EMS_Opt", "cannot be used with CVODE"); return 0;}
