...
#define initmodel initmodel__Kd
#define _net_receive _net_receive__Kd
#define nrn_state_launcher nrn_state_Kd_launcher
#define nrn_cur_launcher nrn_cur_Kd_launcher
#define nrn_jacob_launcher nrn_jacob_Kd_launcher 
#define rates rates_Kd 
#define states states_Kd 
...
#define _slist1 _slist1_Kd
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_Kd
int* _dlist1;
...
LIKWID_MARKER_START("Kd_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
