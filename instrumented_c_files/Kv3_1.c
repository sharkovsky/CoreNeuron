...
#define initmodel initmodel__Kv3_1
#define _net_receive _net_receive__Kv3_1
#define nrn_state_launcher nrn_state_Kv3_1_launcher
#define nrn_cur_launcher nrn_cur_Kv3_1_launcher
#define nrn_jacob_launcher nrn_jacob_Kv3_1_launcher 
#define rates rates_Kv3_1 
#define states states_Kv3_1 
...
#define _slist1 _slist1_Kv3_1
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_Kv3_1
int* _dlist1;
...
LIKWID_MARKER_START("Kv3_1_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("Kv3_1_current");
#endif
...
/* insert compiler dependent ivdep like pragma */
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_START("Kv3_1_state");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("Kv3_1_state");
#endif
}
