...
#define initmodel initmodel__Im_v2
#define _net_receive _net_receive__Im_v2
#define nrn_state_launcher nrn_state_Im_v2_launcher
#define nrn_cur_launcher nrn_cur_Im_v2_launcher
#define nrn_jacob_launcher nrn_jacob_Im_v2_launcher 
#define rates rates_Im_v2 
#define states states_Im_v2 
...
extern "C" {
 ...
 #if defined(PG_ACC_BUGS)
#define _celsius_ _celsius__Im_v2
double _celsius_;
...
#define _slist1 _slist1_Im_v2
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_Im_v2
int* _dlist1;
...
LIKWID_MARKER_START("Im_v2_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("Im_v2_current");
#endif
...
/* insert compiler dependent ivdep like pragma */
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_START("Im_v2_state");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("Im_v2_state");
#endif
}
