...
#define Rstate _p[19*_STRIDE]
#define tsyn_fac _p[20*_STRIDE]
#define u _p[21*_STRIDE]
#define A_GABAA _p[22*_STRIDE]
#define B_GABAA _p[23*_STRIDE]
#define A_GABAB _p[24*_STRIDE]
#define B_GABAB _p[25*_STRIDE]
#define factor_GABAA _p[26*_STRIDE]
#define factor_GABAB _p[27*_STRIDE]
#define DA_GABAA _p[28*_STRIDE]
#define DB_GABAA _p[29*_STRIDE]
#define DA_GABAB _p[30*_STRIDE]
#define DB_GABAB _p[31*_STRIDE]
#define _v_unused _p[32*_STRIDE]
#define _g_unused _p[33*_STRIDE]
#define _tsav _p[34*_STRIDE]
...
LIKWID_MARKER_START("ProbGABAAB_EMS_net_recv");
#endif
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbGABAAB_EMS_net_recv");
#endif
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_START("ProbGABAAB_EMS_current");
#endif
for (_iml = 0; _iml < _cntml_actual; ++_iml) {
#else /* LAYOUT > 1 */ /*AoSoA*/
#error AoSoA not implemented.
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbGABAAB_EMS_current");
#endif
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_START("ProbGABAAB_EMS_reduction_cur");
#endif
#ifdef _OPENACC
    if(!(_nt->compute_gpu)) { 
        for (_iml = 0; _iml < _cntml_actual; ++_iml) {
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbGABAAB_EMS_reduction_cur");
#endif
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_START("ProbGABAAB_EMS_state");
#endif
for (_iml = 0; _iml < _cntml_actual; ++_iml) {
#else /* LAYOUT > 1 */ /*AoSoA*/
#error AoSoA not implemented.
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbGABAAB_EMS_state");
#endif
}
