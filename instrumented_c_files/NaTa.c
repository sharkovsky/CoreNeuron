...
#define initmodel initmodel__NaTa
#define _net_receive _net_receive__NaTa
#define nrn_state_launcher nrn_state_NaTa_launcher
#define nrn_cur_launcher nrn_cur_NaTa_launcher
#define nrn_jacob_launcher nrn_jacob_NaTa_launcher 
#define rates rates_NaTa 
#define states states_NaTa 
...
extern "C" {
 ...
 #if defined(PG_ACC_BUGS)
#define _celsius_ _celsius__NaTa
double _celsius_;
...
#define _slist1 _slist1_NaTa
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_NaTa
int* _dlist1;
...
LIKWID_MARKER_START("NaTa_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("NaTa_current");
#endif
...
/* insert compiler dependent ivdep like pragma */
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_START("NaTa_state");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
