...
#define nrn_init _nrn_init__ProbFiltAMPANMDA_EMS
#define nrn_cur _nrn_cur__ProbFiltAMPANMDA_EMS
#define _nrn_current _nrn_current__ProbFiltAMPANMDA_EMS
#define nrn_jacob _nrn_jacob__ProbFiltAMPANMDA_EMS
#define nrn_state _nrn_state__ProbFiltAMPANMDA_EMS
#define initmodel initmodel__ProbFiltAMPANMDA_EMS
#define _net_receive _net_receive__ProbFiltAMPANMDA_EMS
#define nrn_state_launcher nrn_state_ProbFiltAMPANMDA_EMS_launcher
#define nrn_cur_launcher nrn_cur_ProbFiltAMPANMDA_EMS_launcher
#define nrn_jacob_launcher nrn_jacob_ProbFiltAMPANMDA_EMS_launcher 
#if NET_RECEIVE_BUFFERING
#define _net_buf_receive _net_buf_receive_ProbFiltAMPANMDA_EMS
static void _net_buf_receive(_NrnThread*);
#endif
 
#define setRNG setRNG_ProbFiltAMPANMDA_EMS 
#define state state_ProbFiltAMPANMDA_EMS 
...
#define AMPA_ratio _p[15*_STRIDE]
#define i _p[16*_STRIDE]
#define i_AMPA _p[17*_STRIDE]
#define i_NMDA _p[18*_STRIDE]
#define g_AMPA _p[19*_STRIDE]
#define g_NMDA _p[20*_STRIDE]
#define g _p[21*_STRIDE]
#define Rstate _p[22*_STRIDE]
#define tsyn_fac _p[23*_STRIDE]
#define u _p[24*_STRIDE]
#define A_AMPA _p[25*_STRIDE]
#define B_AMPA _p[26*_STRIDE]
#define A_NMDA _p[27*_STRIDE]
#define B_NMDA _p[28*_STRIDE]
#define isoma _p[29*_STRIDE]
#define factor_AMPA _p[30*_STRIDE]
#define factor_NMDA _p[31*_STRIDE]
#define idend _p[32*_STRIDE]
#define mggate _p[33*_STRIDE]
#define DA_AMPA _p[34*_STRIDE]
#define DB_AMPA _p[35*_STRIDE]
#define DA_NMDA _p[36*_STRIDE]
#define DB_NMDA _p[37*_STRIDE]
#define Disoma _p[38*_STRIDE]
...
#endif /*BBCORE*/
#define toggleVerbose toggleVerbose_ProbFiltAMPANMDA_EMS
#define urand urand_ProbFiltAMPANMDA_EMS
 inline double toggleVerbose( _threadargsproto_ );
 inline double urand( _threadargsproto_ );
 /* declare global and static user variables */
#define gmax gmax_ProbFiltAMPANMDA_EMS
 double gmax = 0.001;
...
static void _acc_globals_update() {
 ...
 "gmax_ProbFiltAMPANMDA_EMS", &gmax_ProbFiltAMPANMDA_EMS,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _ProbFiltAMPANMDA_EMS_reg() {
	int _vectorized = 1;
  _initlists();
...
#define _slist1 _slist1_ProbFiltAMPANMDA_EMS
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_ProbFiltAMPANMDA_EMS
int* _dlist1;
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbFiltAMPANMDA_EMS_net_recv");
#endif
  #pragma acc wait(stream_id)
  _nrb->_displ_cnt = 0;
  _nrb->_cnt = 0;
  /*printf("_net_buf_receive__ProbFiltAMPANMDA_EMS  %d\n", _nt->_id);*/
...
/*VERBATIM*/
   ...
   // hijacking _g_unused to be used instead of Pr from DetAMPANMDA
   _g_unused = u * Rstate ;
   ...
   A_AMPA = A_AMPA + _g_unused * _args[1] * factor_AMPA ;
   B_AMPA = B_AMPA + _g_unused * _args[1] * factor_AMPA ;
   A_NMDA = A_NMDA + _g_unused * _args[2] * factor_NMDA ;
   B_NMDA = B_NMDA + _g_unused * _args[2] * factor_NMDA ;
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbFiltAMPANMDA_EMS_current");
#endif
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_START("ProbFiltAMPANMDA_EMS_reduction_cur");
#endif
#ifdef _OPENACC
    if(!(_nt->compute_gpu)) { 
        for (_iml = 0; _iml < _cntml_actual; ++_iml) {
...
#ifndef DISABLE_LIKWID_ON_SYN
LIKWID_MARKER_STOP("ProbFiltAMPANMDA_EMS_reduction_cur");
#endif
}
