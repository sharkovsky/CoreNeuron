...
#define initmodel initmodel__SK
#define _net_receive _net_receive__SK
#define nrn_state_launcher nrn_state_SK_launcher
#define nrn_cur_launcher nrn_cur_SK_launcher
#define nrn_jacob_launcher nrn_jacob_SK_launcher 
#define rates rates_SK 
#define states states_SK 
...
#define _slist1 _slist1_SK
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_SK
int* _dlist1;
...
LIKWID_MARKER_START("SK_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
