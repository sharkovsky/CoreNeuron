...
#define initmodel initmodel__CaDynamics
#define _net_receive _net_receive__CaDynamics
#define nrn_state_launcher nrn_state_CaDynamics_launcher
#define nrn_cur_launcher nrn_cur_CaDynamics_launcher
#define nrn_jacob_launcher nrn_jacob_CaDynamics_launcher 
#define states states_CaDynamics 
...
extern "C" {
 ...
 #define FARADAY FARADAY_CaDynamics
...
#define _slist1 _slist1_CaDynamics
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_CaDynamics
int* _dlist1;
...
LIKWID_MARKER_START("CaDynamics_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("CaDynamics_current");
#endif
...
/* insert compiler dependent ivdep like pragma */
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_START("CaDynamics_state");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("CaDynamics_state");
#endif
}
