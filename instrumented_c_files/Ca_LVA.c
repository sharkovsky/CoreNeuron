...
#define initmodel initmodel__Ca_LVA
#define _net_receive _net_receive__Ca_LVA
#define nrn_state_launcher nrn_state_Ca_LVA_launcher
#define nrn_cur_launcher nrn_cur_Ca_LVA_launcher
#define nrn_jacob_launcher nrn_jacob_Ca_LVA_launcher 
#define rates rates_Ca_LVA 
#define states states_Ca_LVA 
...
extern "C" {
 ...
 #if defined(PG_ACC_BUGS)
#define _celsius_ _celsius__Ca_LVA
double _celsius_;
...
#define _slist1 _slist1_Ca_LVA
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_Ca_LVA
int* _dlist1;
...
LIKWID_MARKER_START("Ca_LVA_current");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("Ca_LVA_current");
#endif
...
/* insert compiler dependent ivdep like pragma */
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_START("Ca_LVA_state");
#endif
_PRAGMA_FOR_VECTOR_LOOP_
...
#ifndef DISABLE_LIKWID_ON_MECH
LIKWID_MARKER_STOP("Ca_LVA_state");
#endif
}
